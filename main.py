...
#Youtube channel Name : Brain Flicks
#Link : https://www.youtube.com/channel/UCbOEPb3tm0yOA5GIsrPX_EQ      Press CTRL + ( Tap on link)

root = Tk()
root.geometry("650x400+300+300")

root.title("Scientific Calculator Project")
